namespace FEA
{
	partial class ComprobanteForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.fecha_serv_desdeLabel = new System.Windows.Forms.Label();
			this.fecha_serv_hastaLabel = new System.Windows.Forms.Label();
			this.fecha_venc_pagoLabel = new System.Windows.Forms.Label();
			this.imp_netoLabel = new System.Windows.Forms.Label();
			this.imp_op_exLabel = new System.Windows.Forms.Label();
			this.imp_tot_concLabel = new System.Windows.Forms.Label();
			this.imp_totalLabel = new System.Windows.Forms.Label();
			this.ptoVentaTextBox = new System.Windows.Forms.TextBox();
			this.fecha_cbteDateTimePicker = new System.Windows.Forms.DateTimePicker();
			this.tipoComprobanteComboBox = new System.Windows.Forms.ComboBox();
			this.caeTextBox = new System.Windows.Forms.TextBox();
			...
			this.fecha_serv_desdeDateTimePicker = new System.Windows.Forms.DateTimePicker();
			this.impto_liqLabel = new System.Windows.Forms.Label();
			this.impto_liq_rniLabel = new System.Windows.Forms.Label();
			this.imp_netoTextBox = new System.Windows.Forms.TextBox();
			this.imp_op_exTextBox = new System.Windows.Forms.TextBox();
			this.imp_tot_concTextBox = new System.Windows.Forms.TextBox();
			this.impto_liq_rniTextBox = new System.Windows.Forms.TextBox();
			this.impto_liqTextBox = new System.Windows.Forms.TextBox();
			this.imp_totalTextBox = new System.Windows.Forms.TextBox();
			this.ComprobanteToolTip = new System.Windows.Forms.ToolTip(this.components);
			this.nro_docTextBox = new System.Windows.Forms.TextBox();
			this.tipo_docComboBox = new System.Windows.Forms.ComboBox();
			this.nro_docLabel = new System.Windows.Forms.Label();
			this.resultadoLabel = new System.Windows.Forms.Label();
			this.motivoLabel = new System.Windows.Forms.Label();
			this.resultadoTextBox = new System.Windows.Forms.TextBox();
			this.motivoTextBox = new System.Windows.Forms.TextBox();
			this.EnviarIBKButton = new System.Windows.Forms.Button();
			...
			this.fecha_cbteLabel.Text = "Fecha comprobante";
			// 
			...
			this.fecha_serv_desdeLabel.Text = "Inicio servicio";
			// 
			...
			this.fecha_serv_hastaLabel.Text = "Fin servicio";
			// 
			...
			this.imp_op_exLabel.Text = "Exento";
			// 
			// imp_tot_concLabel
			// 
			...
			this.imp_tot_concLabel.Text = "Total conceptos";
			// 
			// imp_totalLabel
			// 
			...
			this.imp_totalLabel.Text = "Total";
			// 
			// ptoVentaTextBox
			// 
			...
			// EnviarButton
			// 
			this.EnviarButton.Location = new System.Drawing.Point(146, 408);
			this.EnviarButton.Name = "EnviarButton";
			this.EnviarButton.Size = new System.Drawing.Size(137, 45);
			this.EnviarButton.TabIndex = 19;
			this.EnviarButton.Text = "Enviar AFIP";
			...
			this.prestaServicioCheckBox.Text = "Presta servicio";
			this.prestaServicioCheckBox.UseVisualStyleBackColor = true;
			// 
			...
			this.ComprobanteToolTip.SetToolTip(this.fecha_serv_hastaDateTimePicker, "Fecha de fin del servicio a facturar");
			// 
			...
			this.ComprobanteToolTip.SetToolTip(this.fecha_venc_pagoDateTimePicker, "Fecha de vencimiento de la factura");
			// 
			...
			this.ComprobanteToolTip.SetToolTip(this.fecha_serv_desdeDateTimePicker, "Fecha de inicio del  servicio a facturar");
			// 
			// impto_liqLabel
			// 
			...
			this.impto_liqLabel.Text = "Liquidado";
			// 
			// impto_liq_rniLabel
			// 
			...
			this.impto_liq_rniLabel.Text = "Impuesto a RNI";
			// 
			// imp_netoTextBox
			// 
			...
			this.ComprobanteToolTip.SetToolTip(this.nro_docTextBox, "Importe neto gravado");
			// 
			// tipo_docComboBox
			// 
			...
			this.nro_docLabel.Text = "Tipo y n° documento";
			// 
			// resultadoLabel
			// 
			...
			// EnviarIBKButton
			// 
			this.EnviarIBKButton.Location = new System.Drawing.Point(289, 407);
			this.EnviarIBKButton.Name = "EnviarIBKButton";
			this.EnviarIBKButton.Size = new System.Drawing.Size(144, 46);
			this.EnviarIBKButton.TabIndex = 43;
			this.EnviarIBKButton.Text = "Enviar Interfacturas";
			this.EnviarIBKButton.UseVisualStyleBackColor = true;
			this.EnviarIBKButton.Click += new System.EventHandler(this.EnviarIBKButton_Click);
			// 
			// XMLButton
			// 
			this.XMLButton.Location = new System.Drawing.Point(9, 407);
			this.XMLButton.Name = "XMLButton";
			this.XMLButton.Size = new System.Drawing.Size(133, 46);
			...
			// ExcelButton
			// 
			this.ExcelButton.Location = new System.Drawing.Point(12, 459);
			this.ExcelButton.Name = "ExcelButton";
			this.ExcelButton.Size = new System.Drawing.Size(420, 46);
			...
			this.Controls.Add(this.EnviarIBKButton);
			this.Controls.Add(this.motivoTextBox);
			this.Controls.Add(this.resultadoTextBox);
			this.Controls.Add(this.motivoLabel);
			this.Controls.Add(this.resultadoLabel);
			this.Controls.Add(this.nro_docTextBox);
			this.Controls.Add(this.tipo_docComboBox);
			this.Controls.Add(this.nro_docLabel);
			this.Controls.Add(this.impto_liq_rniTextBox);
			this.Controls.Add(this.impto_liqTextBox);
			this.Controls.Add(this.imp_totalTextBox);
			this.Controls.Add(this.imp_tot_concTextBox);
			this.Controls.Add(this.imp_op_exTextBox);
			this.Controls.Add(this.imp_netoTextBox);
			this.Controls.Add(this.impto_liq_rniLabel);
			this.Controls.Add(this.impto_liqLabel);
			this.Controls.Add(this.fecha_serv_desdeDateTimePicker);
			this.Controls.Add(this.fecha_venc_pagoDateTimePicker);
			this.Controls.Add(this.fecha_serv_hastaDateTimePicker);
			this.Controls.Add(this.prestaServicioCheckBox);
			this.Controls.Add(this.caeTextBox);
			...
			this.Controls.Add(this.imp_totalLabel);
			this.Controls.Add(this.imp_tot_concLabel);
			this.Controls.Add(this.imp_op_exLabel);
			this.Controls.Add(this.imp_netoLabel);
			this.Controls.Add(this.fecha_venc_pagoLabel);
			this.Controls.Add(this.fecha_serv_hastaLabel);
			this.Controls.Add(this.fecha_serv_desdeLabel);
			this.Controls.Add(this.fecha_cbteLabel);
		...
		private System.Windows.Forms.Label fecha_cbteLabel;
		private System.Windows.Forms.Label fecha_serv_desdeLabel;
		private System.Windows.Forms.Label fecha_serv_hastaLabel;
		private System.Windows.Forms.Label fecha_venc_pagoLabel;
		private System.Windows.Forms.Label imp_netoLabel;
		private System.Windows.Forms.Label imp_op_exLabel;
		private System.Windows.Forms.Label imp_tot_concLabel;
		private System.Windows.Forms.Label imp_totalLabel;
		private System.Windows.Forms.TextBox ptoVentaTextBox;
		private System.Windows.Forms.DateTimePicker fecha_cbteDateTimePicker;
		...
		private System.Windows.Forms.DateTimePicker fecha_serv_desdeDateTimePicker;
		private System.Windows.Forms.Label impto_liqLabel;
		private System.Windows.Forms.Label impto_liq_rniLabel;
		private System.Windows.Forms.TextBox imp_netoTextBox;
		private System.Windows.Forms.TextBox imp_op_exTextBox;
		private System.Windows.Forms.TextBox imp_tot_concTextBox;
		private System.Windows.Forms.TextBox impto_liq_rniTextBox;
		private System.Windows.Forms.TextBox impto_liqTextBox;
		private System.Windows.Forms.TextBox imp_totalTextBox;
		private System.Windows.Forms.ToolTip ComprobanteToolTip;
		private System.Windows.Forms.ComboBox tipo_docComboBox;
		private System.Windows.Forms.Label nro_docLabel;
		private System.Windows.Forms.TextBox nro_docTextBox;
		private System.Windows.Forms.Label resultadoLabel;
		private System.Windows.Forms.Label motivoLabel;
		private System.Windows.Forms.TextBox resultadoTextBox;
		private System.Windows.Forms.TextBox motivoTextBox;
		private System.Windows.Forms.Button EnviarIBKButton;
